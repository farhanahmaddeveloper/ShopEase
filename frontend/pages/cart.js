...
const Cart = () => {
    ...
    useEffect(() => {
         // Fetch the username from local cookies
            ...
            <Wrapper user={user}>
                ...
                {cartItems.length < 1 && (
                    <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
                        ...
                        <Link
                            href="/shop"
                            className="py-4 px-8 rounded-full bg-pink-600 text-white text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75 mt-8"
                        >
                            Continue Shopping
                        </Link>
                    </div>
